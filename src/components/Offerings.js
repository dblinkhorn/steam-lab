      ...
      <div className="offerings">
        <div className="offerings-left">
          ...
          <div className="offerings__text">
            ...
            <span className="offerings__small-text">
              42 challenge videos (six per grade-level, Kindergarten through
              sixth)
            </span>
            <br />
          </div>
        ...
        <div className="offerings-center">
          ...
          <div className="offerings__text">
            ...
            <span className="offerings__small-text">
              Additional teacher resource documents for extension and enrichment
            </span>
          </div>
        </div>
        <div className="offerings-right">
          ...
          <div className="offerings__text">
            ...
            <span className="offerings__small-text">
              Designed for simple implementation with easy-to-find materials
            </span>
          </div>
        </div>
      </div>
