      ...
      <div className="home-container">
        <div className="home-text">
          <p className="motto">
            ...
            and Learning
            <br />
            <span className="blue-text">Come Together</span>
          </p>
          <span className="description">
            Online STEAM video challenges to support students, teachers, and
          ...
          <div className="buttons__container">
            ...
            <div className="sample-button__container">
              <Link to="/samples">
                <button className="button-sample-lessons"></button>
                <span className="button-sample-lessons__text">
                  Sample Lessons
                </span>
              </Link>
            </div>
        ...
        <div className="overview__content">
          ...
          <div className="overview__text">
            <ul>
              ...
              <li>
                Mr Reed demonstrates step-by-step instructions in every video
              </li>
